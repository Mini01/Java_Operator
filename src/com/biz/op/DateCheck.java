...
public class DateCheck {
	...
	public static void main(String[] args) {
		...
		// 이때 이 문자열을 날짜 형식에 맞는지 검사
		
		String date1 = "1991/01/01";
		String date2 = "1991/02/29";
		String date3 = "2018/11/31";
		
		SimpleDateFormat dateCheck = new SimpleDateFormat("yyy/MM/dd");
		dateCheck.setLenient(false);
		
		// SimpleDateFormat의 parse() 메소드는 문자열의 날짜값이 유요하지 않으면
		// 예외를 발생시키도록 구조가 만들어져 있다.
		// 이 예외 발생 구조를 역으로 활용해서 만약 문자열형식의 날짜가 유효하지 않으면
		// try.. catch를 활용해서 유효하지 않음을 입력자(사용자)에게 알려줄수 있다.
		try {
